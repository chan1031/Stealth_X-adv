    ...
    for i, (images, bboxes, labels, scale, img_id) in enumerate(tqdm(loader)):
        ...
        for j in range(images.shape[0]):
            for k in range(bboxes[j].shape[0]):
                ...
                all_gts[label][t].append([bbox[1], bbox[0], bbox[3], bbox[2], label, 0])
